...
<div class="form-group">
	...
	<select class="form-control" name="role" id="role" required <?php if ( isset($id) && $id == $_SESSION['user']['id']){ echo 'disabled';} // If it's our own user, set disabled and if not, set required to on ?>>
		<?php
		$access_level_sql = '';
		...
		// Dy while loop to create option for each row in the database
